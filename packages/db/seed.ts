...
async function seed() {
  ...
  await prisma.heroTitle.createMany({
    data: [
      ...
      { title: "Software Developer", sortOrder: 100, version: "v2" },
    ],
  });
  ...
  const skillsData = [
    ...
    { name: "REST APIs", iconKey: "REST APIs", show: true, sortOrder: 11 },
    { name: "WebSockets", iconKey: "WebSockets", show: true, sortOrder: 12 },
    { name: "PostgreSQL", iconKey: "PostgreSQL", show: true, sortOrder: 13 },
    { name: "MongoDB", iconKey: "MongoDB", show: true, sortOrder: 14 },
    { name: "MySQL", iconKey: "MySQL", show: true, sortOrder: 15 },
    { name: "Redis", iconKey: "Redis", show: true, sortOrder: 16 },
    { name: "Prisma", iconKey: "Prisma", show: true, sortOrder: 17 },
    { name: "Drizzle", iconKey: "Drizzle ORM", show: true, sortOrder: 18 },
    { name: "SQL", iconKey: "SQL", show: true, sortOrder: 19 },
    { name: "Kafka", iconKey: "Kafka", show: true, sortOrder: 20 },
    { name: "Docker", iconKey: "Docker", show: true, sortOrder: 21 },
    { name: "AWS", iconKey: "AWS", show: true, sortOrder: 22 },
    { name: "AWS S3", iconKey: "AWS S3", show: true, sortOrder: 23 },
    { name: "AWS EC2", iconKey: "AWS EC2", show: true, sortOrder: 24 },
    { name: "CI/CD", iconKey: "CI/CD", show: true, sortOrder: 25 },
    { name: "Jenkins", iconKey: "Jenkins", show: true, sortOrder: 26 },
    { name: "Nginx", iconKey: "Nginx", show: true, sortOrder: 27 },
    { name: "Cloudflare", iconKey: "Cloudflare", show: true, sortOrder: 28 },
    { name: "Cloudflare R2", iconKey: "Cloudflare R2", show: true, sortOrder: 29 },
    { name: "Monitoring", iconKey: "Monitoring", show: true, sortOrder: 30 },
    { name: "Logging", iconKey: "Logging", show: true, sortOrder: 31 },
    { name: "Java", iconKey: "Java", show: true, sortOrder: 32 },
    { name: "DSA", iconKey: "DSA", show: true, sortOrder: 33 },
    { name: "OOPs", iconKey: "OOPs", show: true, sortOrder: 34 },
    { name: "Git", iconKey: "Git", show: true, sortOrder: 35 },
    { name: "GitHub", iconKey: "GitHub", show: true, sortOrder: 36 },
    ...
    { name: "GitHub Actions", iconKey: "GitHub Actions", show: true, sortOrder: 37 },
    { name: "Turborepo", iconKey: "Turborepo", show: true, sortOrder: 38 },
    { name: "Bun", iconKey: "Bun", show: true, sortOrder: 39 },
    { name: "Jest", iconKey: "Jest", show: true, sortOrder: 40 },
    { name: "Selenium", iconKey: "Selenium", show: true, sortOrder: 41 },
    { name: "Jira", iconKey: "Jira", show: true, sortOrder: 42 },
  ...
  await prisma.project.create({
    data: {
      title: "Grill",
      summary: "AI mock interview platform — adaptive follow-ups, voice & video answers, and measured delivery scoring.",
      ...
      bullets: {
        create: [
          { content: "**Architected an end-to-end AI interview platform** — dynamically generates interviews from job descriptions, résumés, custom topics, or behavioral (cultural-fit) tracks with adaptive AI follow-ups, supporting text, voice, and video-recorded responses.", sortOrder: 0 },
          { content: "**Engineered a quantitative voice-analytics pipeline** — built a dedicated FastAPI + Parselmouth microservice that measures pace, pauses, filler words, pitch, and energy directly from raw audio, delivering reports with per-question scoring, model ideal answers, and personalized improvement guidance.", sortOrder: 1 },
          { content: "**Designed fault-tolerant, secure infrastructure** — implemented Gemini with automatic Groq failover via rotating API key pools (exponential backoff on 429/5xx), Groq Whisper speech-to-text, an idempotent self-healing report pipeline, and Argon2 + JWT (jose) authentication with strict per-user data isolation.", sortOrder: 2 },
        ],
      },
    },
  });
