...
(function oneko() {
  ...
  const savedPos = JSON.parse(localStorage.getItem('oneko-pos') || 'null');
  let nekoPosX = savedPos ? savedPos.x : 32;
  let nekoPosY = savedPos ? savedPos.y : 32;
  ...
  function savePos() {
    localStorage.setItem('oneko-pos', JSON.stringify({ x: nekoPosX, y: nekoPosY }));
  }
